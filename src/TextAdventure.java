...
public class TextAdventure {
	...
	public static void main(String[] args) {
		...
		pc = new Player();
		/*
		 * This welcomes the player to their game and prompts them for their
		 * name.
		 */
		...
		System.out.println();
		/*
		 * This loops is the main logic of the game. It prints out the number of
		 * turns, and the current room, and prompts them for input. Some rooms
		 * will generate special messages.
		 */
		while (pc.isAlive()) {
			boolean known = false;
			// checks to see if this room has been visited already and if not
			// creates the room
			Room cur;
			...
			// informs the player of the turn number and lets them know their
			// current room and if they can hear
	...
	private static void lookAtInventory(Player p, Scanner input, Enemy e) {
		...
		while (!done) {
			...
			if (action.equals("exit")) {
				...
				if (pc.position.x == e.position.x && p.position.y == e.position.y) {
					lose();
				}
